...
# email = "vishalreddy4500@gmail.com"
# password = "12!@qwQW"
...
email = env.get("LINKEDIN_EMAIL", "")
password = env.get("LINKEDIN_PASSWORD", "")
headless = False  # Set True to run invisibly

# (Optional) Use Chrome profile to stay logged in
chromeProfilePath = r""  # e.g. r"C:\Users\<You>\AppData\Local\Google\Chrome\User Data\Default"

# Job search filters
location = ["India"]
keywords = ["frontend", "react", "typescript", "javascript", "python"]
experienceLevels = ["Entry level"]
datePosted = ["Past Week"]
jobType = ["Full-time", "Contract"]
remote = ["Remote", "Hybrid"]
salary = ["₹400,000+"]  # Equivalent to ~$5,000+, suitable for Hyderabad
sort = ["Recent"]

# Blacklists & preferences
blacklistCompanies = []  
blackListTitles = []
followCompanies = False

# Pro settings (require paid version, leave defaults for now)
preferredCv = 1
outputSkippedQuestions = True
useAiAutocomplete = False
onlyApplyCompanies = []
...
# Leave other platform settings empty
firefoxProfileRootDir = r""
AngelCoBotPassword = ""
AngelCoEmail = ""
AngelCoPassword = ""
...
LastName = "Reddy"
Email = "vishalreddy4500@gmail.com"
LinkedInProfileURL = "https://www.linkedin.com/in/vishalreddy4500/"
Phone = ""
Location = "Hyderabad, India"
HowDidYouHeard = ""
ConsiderMeForFutureOffers = True
displayWarnings = False
